...
type AdminTab = 'staff' | 'cost-centers' | 'timesheets' | 'cooperative' | 'profitability' | 'user-activity';
  ...
  return (
    <div className="admin-dashboard">
      ...
      <div className="tab-navigation">
        ...
        <button
          className={`tab-button ${activeTab === 'user-activity' ? 'active' : ''}`}
      ...
      <div className="tab-content">
        ...
        {activeTab === 'user-activity' && <UserActivityPage />}
      </div>
    </div>
  );
}
